...
Steps.defaultProps = {
  step3Description:
    'Sit back and relax while our skilled painters transform your space with precision and care.',
  step2Title: 'Get Expert Advice',
  step1Title: 'Choose Your Paint',
  step4Description:
    'We partner with top brands like Sakarni Putty to ensure that your paint job is durable and long-lasting.',
  step3Title: 'Professional Painting Service',
  step1Description:
    'Browse through our wide range of Asian Paints and select the perfect color for your space.',
  step4Title: 'Quality Assurance',
  step2Description:
    'Consult with our experienced team to get recommendations on the best paint type and finish for your project.',
}
