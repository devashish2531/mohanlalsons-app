...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description: "Wide range of interior decor options available to complement your newly painted spaces.",
    ...
    },
    {
      ...
      description: "Professional painting services for a flawless finish by our team of experienced painters.",
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <span className="text-paint-red font-medium text-sm">OUR SERVICES</span>
              <div className="h-px w-8 bg-paint-red"></div>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Why Choose Us</h2>
            <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
              At Mohan Lal and Sons, we pride ourselves on offering the best painting solutions in Pataudi
            </p>
          </div>
