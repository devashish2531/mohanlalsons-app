        ...
        <div className="footer13-max-width thq-section-max-width">
          <div className="footer13-credits1">
            ...
            <span>
              {props.copyright ?? (
                <Fragment>
                  <span className="footer13-text1 thq-body-small">
